...
class AdvancedMetrics:
    ...
    def __init__(self, model, tokenizer, device):
        ...
        try:
            ...
            print("⚠️ rouge-score no instalado. ROUGE-L no estará disponible.")
    ...
    def compute_rouge_l(self, reference: str, hypothesis: str) -> float:
        ...
        try:
            ...
            print(f"⚠️ Error calculando ROUGE-L: {e}")
            return 0.0
    ...
    def compute_entropy(self, text: str) -> float:
        ...
        try:
            ...
            print(f"⚠️ Error calculando entropía: {e}")
            return 0.0
    ...
    def __init__(self, use_classifier: bool = False):
        ...
        if use_classifier:
            try:
                ...
                print(f"⚠️ No se pudo cargar clasificador: {e}")
